    ...
    <div className="bg-white rounded-[var(--radius-lg)] p-8 shadow-ps-md">
      ...
      <div className="relative my-5">
        ...
        <div className="relative flex justify-center">
          <span className="bg-white px-3 text-xs text-[var(--muted-foreground)]">oppure</span>
        </div>
      </div>

      <button
        onClick={handleGoogle}
        className="w-full border border-[var(--border)] py-2.5 rounded-[var(--radius-md)] text-sm font-medium hover:border-[var(--primary)] transition-colors flex items-center justify-center gap-2"
      >
